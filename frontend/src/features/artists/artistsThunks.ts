...
export const fetchOneArtist = createAsyncThunk<Artist, string>('artists/fetchOne', async (id) => {
...
export const removeArtist = createAsyncThunk<void, string>('artists/remove', async (id) => {
  await axiosApi.delete('/artists/' + id);
});

export const artistTogglePublished = createAsyncThunk<void, Artist>('artists/togglePublished', async (artist) => {
  await axiosApi.patch('/artists/' + artist._id + '/togglePublished', artist);
});
